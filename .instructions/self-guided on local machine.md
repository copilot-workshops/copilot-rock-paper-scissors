...
The following instructions will help you get started with GitHub Copilot. You'll walk through a simple starter exercise and then try to solve a number of challenges with your next Copilot pair programmer. 

## Environment setup

Please read through each of the following sections to ensure your **local environment** is setup correctly for the best GitHub Copilot workshop experience.
